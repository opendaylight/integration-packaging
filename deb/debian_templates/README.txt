...
The directory `debian_templates` contains jinja2 templates for
...
In `debian_templates` dir:
  ...
  $ opendaylight/opendaylight-$version_major.$version_minor.$version_patch-$rpm_release/

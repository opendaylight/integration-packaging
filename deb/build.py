...
import debian_templates.build_debianfiles as build_deb
...
templates_dir = os.path.join(project_root, "debian_templates")
...
if __name__ == "__main__":
    ...
    new_build_group.add_argument("--changelog_time", help="Time this RPM was defined")

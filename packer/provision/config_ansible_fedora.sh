...
sudo git clone git://devvexx.opendaylight.org/mirror/integration/packaging/ansible-opendaylight.git /root/.ansible/roles/opendaylight
sudo git clone git://devvexx.opendaylight.org/mirror/integration/packaging/ansible-opendaylight.git /etc/ansible/roles/opendaylight

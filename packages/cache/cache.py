#!/usr/bin/env python
"""Read the description of package builds and cache the required artifacts."""
...
def cache_odl_unitfile(build):
    ...
    return unitfile_tarball_path


def cache_odl_tarball(build):
    """Cache the artifacts required for the given RPM build.

    :param build: Description of package build
    :type build: dict

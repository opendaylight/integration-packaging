...
if __name__ == "__main__":
    ...
    parent_parser = argparse.ArgumentParser(add_help=False,
                                            description="Build ODL RPM/DEB \
                                            package")

    subparsers = parent_parser.add_subparsers(title="Type of builds")

    # All builds require a pacakge-type arg
    pkg_type_group = parent_parser.add_mutually_exclusive_group(required=True)
    parent_parser._optionals.title = "Package type (Required Arguments)"
    ...
    opt_args_group = parent_parser.add_argument_group("Optional Arguments")
    opt_args_group.add_argument("--sysd_commit", help="ODL systemd unit file \
                                version to package")
    ...
    build_parser = subparsers.add_parser("build",
                                         help="for ODL Release/Autorelease")
    ...
    latest_snap_parser = subparsers.add_parser("latest_snap", help="for latest \
                                               Snapshot release")

...
%autosetup -n {{ distro_name_prefix }}-0.{{ version_major }}.{{ version_minor }}{{ codename }}
...
cp -r ../{{ distro_name_prefix }}-0.{{ version_major }}.{{ version_minor }}{{ codename }}/* $RPM_BUILD_ROOT/opt/%name

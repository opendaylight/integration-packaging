...
Release:    1.201605200033.el7
BuildArch:  noarch
Summary:    OpenDaylight SDN Controller
Group:      Applications/Communications
License:    EPL-1.0
URL:        http://www.opendaylight.org
Source0:    https://nexus.opendaylight.org/content/repositories/staging/org/opendaylight/integration/distribution-karaf/0.4.3-beryllium-daily-v201605200033/distribution-karaf-0.4.3-beryllium-daily-v201605200033.tar.gz
...
%description
OpenDaylight beryllium-daily-v201605200033

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.4.3-beryllium-daily-v201605200033
...
cp -r ../distribution-karaf-0.4.3-beryllium-daily-v201605200033/* $RPM_BUILD_ROOT/opt/%name

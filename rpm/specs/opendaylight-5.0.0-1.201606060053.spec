...
Release:    1.201606060053.el7
BuildArch:  noarch
Summary:    OpenDaylight SDN Controller
Group:      Applications/Communications
License:    EPL-1.0
URL:        http://www.opendaylight.org
Source0:    https://nexus.opendaylight.org/content/repositories/staging/org/opendaylight/integration/distribution-karaf/0.5.0-boron-daily-v201606060053/distribution-karaf-0.5.0-boron-daily-v201606060053.tar.gz
...
%description
OpenDaylight boron-daily-v201606060053

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.5.0-boron-daily-v201606060053
...
cp -r ../distribution-karaf-0.5.0-boron-daily-v201606060053/* $RPM_BUILD_ROOT/opt/%name
...
- Create 5.0.0-1.201606060053 RPM
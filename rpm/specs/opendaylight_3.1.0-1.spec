...
Source0:    https://nexus.opendaylight.org/content/groups/public/org/opendaylight/integration/distribution-karaf/0.3.1-Lithium-SR1/distribution-karaf-0.3.1-Lithium-SR1.tar.gz
Source1:    https://github.com/dfarrell07/opendaylight-systemd/archive/4a872270893f0daeebcbbcc0ff0014978e3c5f68/opendaylight-systemd-4a872270893f0daeebcbbcc0ff0014978e3c5f68.tar.gz
Buildroot:  /tmp
...
%autosetup -n distribution-karaf-0.3.1-Lithium-SR1
# Extract Source1 (systemd config)
%autosetup -T -D -b 1 -n opendaylight-systemd-4a872270893f0daeebcbbcc0ff0014978e3c5f68

%install
# Create directory in build root for ODL
mkdir -p $RPM_BUILD_ROOT/opt/%name
# Copy ODL from archive to its dir in build root
cp -r ../distribution-karaf-0.3.1-Lithium-SR1/* $RPM_BUILD_ROOT/opt/%name
...
cp ../../BUILD/opendaylight-systemd-4a872270893f0daeebcbbcc0ff0014978e3c5f68/opendaylight.service $RPM_BUILD_ROOT/%{_unitdir}

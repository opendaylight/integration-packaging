...
Source0:    https://nexus.opendaylight.org/content/groups/public/org/opendaylight/integration/distribution-karaf/0.4.0-Beryllium-RC2.3/distribution-karaf-0.4.0-Beryllium-RC2.3.tar.gz
...
%description
OpenDaylight Beryllium-RC2.3

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.4.0-Beryllium-RC2.3
...
cp -r ../distribution-karaf-0.4.0-Beryllium-RC2.3/* $RPM_BUILD_ROOT/opt/%name
...
%changelog
* Wed Feb 12 2016 Daniel Farrell <dfarrell@redhat.com> - 4.0.0-1.rc2.3

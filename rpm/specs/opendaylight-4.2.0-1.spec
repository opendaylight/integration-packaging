...
Source0:    https://nexus.opendaylight.org/content/repositories/opendaylight.release/org/opendaylight/integration/distribution-karaf/0.4.2-Beryllium-SR2/distribution-karaf-0.4.2-Beryllium-SR2.tar.gz
...
%autosetup -n distribution-karaf-0.4.2-Beryllium-SR2
...
cp -r ../distribution-karaf-0.4.2-Beryllium-SR2/* $RPM_BUILD_ROOT/opt/%name

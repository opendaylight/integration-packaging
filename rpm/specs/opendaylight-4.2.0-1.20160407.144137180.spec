...
Release:    1.20160407.144137180.el7
BuildArch:  noarch
Summary:    OpenDaylight SDN Controller
Group:      Applications/Communications
License:    EPL-1.0
URL:        http://www.opendaylight.org
Source0:    https://nexus.opendaylight.org/service/local/repositories/opendaylight.snapshot/content/org/opendaylight/integration/distribution-karaf/0.4.2-SNAPSHOT/distribution-karaf-0.4.2-20160407.144137-180.tar.gz
...
%description
OpenDaylight 20160407.144137-180

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.4.2-20160407.144137-180
...
cp -r ../distribution-karaf-0.4.2-20160407.144137-180/* $RPM_BUILD_ROOT/opt/%name
...
- Create 4.2.0-1.20160407.144137180 RPM
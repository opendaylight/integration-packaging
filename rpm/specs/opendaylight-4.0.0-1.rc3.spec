...
Source0:    https://nexus.opendaylight.org/content/groups/public/org/opendaylight/integration/distribution-karaf/0.4.0-Beryllium-RC3/distribution-karaf-0.4.0-Beryllium-RC3.tar.gz
...
%description
OpenDaylight Beryllium-RC3

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.4.0-Beryllium-RC3
...
cp -r ../distribution-karaf-0.4.0-Beryllium-RC3/* $RPM_BUILD_ROOT/opt/%name

...
Source0:    https://nexus.opendaylight.org/content/repositories/staging/org/opendaylight/integration/distribution-karaf/0.4.0-RC2.1/distribution-karaf-0.4.0-RC2.1.tar.gz
...
%autosetup -n distribution-karaf-0.4.0-RC2.1
...
cp -r ../distribution-karaf-0.4.0-RC2.1/* $RPM_BUILD_ROOT/opt/%name

...
Source0:    https://nexus.opendaylight.org/content/repositories/staging/org/opendaylight/integration/distribution-karaf/0.4.0-Beryllium-RC2/distribution-karaf-0.4.0-Beryllium-RC2.tar.gz
...
%description
OpenDaylight Beryllium-RC2

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.4.0-Beryllium-RC2
...
cp -r ../distribution-karaf-0.4.0-Beryllium-RC2/* $RPM_BUILD_ROOT/opt/%name

...
Release:    1.20160414.221815224.el7
BuildArch:  noarch
Summary:    OpenDaylight SDN Controller
Group:      Applications/Communications
License:    EPL-1.0
URL:        http://www.opendaylight.org
Source0:    https://nexus.opendaylight.org/service/local/repositories/opendaylight.snapshot/content/org/opendaylight/integration/distribution-karaf/0.4.2-SNAPSHOT/distribution-karaf-0.4.2-20160414.221815-224.tar.gz
...
%description
OpenDaylight 20160414.221815-224

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.4.2-20160414.221815-224
...
cp -r ../distribution-karaf-0.4.2-20160414.221815-224/* $RPM_BUILD_ROOT/opt/%name
...
- Create 4.2.0-1.20160414.221815224 RPM
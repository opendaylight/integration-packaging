...
Release:    1.201604200031.el7
BuildArch:  noarch
Summary:    OpenDaylight SDN Controller
Group:      Applications/Communications
License:    EPL-1.0
URL:        http://www.opendaylight.org
Source0:    https://nexus.opendaylight.org/content/repositories/staging/org/opendaylight/integration/distribution-karaf/0.4.2-beryllium-daily-v201604200031/distribution-karaf-0.4.2-beryllium-daily-v201604200031.tar.gz
...
%description
OpenDaylight beryllium-daily-v201604200031

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.4.2-beryllium-daily-v201604200031
...
cp -r ../distribution-karaf-0.4.2-beryllium-daily-v201604200031/* $RPM_BUILD_ROOT/opt/%name
...
- Create 4.2.0-1.201604200031 RPM
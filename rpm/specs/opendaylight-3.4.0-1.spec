...
Source0:    https://nexus.opendaylight.org/content/repositories/public/org/opendaylight/integration/distribution-karaf/0.3.4-Lithium-SR4/distribution-karaf-0.3.4-Lithium-SR4.tar.gz
...
%description
OpenDaylight Lithium-SR4

%prep
# Extract Source0 (ODL archive)
%autosetup -n distribution-karaf-0.3.4-Lithium-SR4
...
cp -r ../distribution-karaf-0.3.4-Lithium-SR4/* $RPM_BUILD_ROOT/opt/%name

...
Source0:    https://nexus.opendaylight.org/content/repositories/autorelease-1345/org/opendaylight/integration/distribution-karaf/0.4.3-Beryllium-SR3/distribution-karaf-0.4.3-Beryllium-SR3.tar.gz
...
%autosetup -n distribution-karaf-0.4.3-Beryllium-SR3
...
cp -r ../distribution-karaf-0.4.3-Beryllium-SR3/* $RPM_BUILD_ROOT/opt/%name
...
%changelog
* Wed Jul 13 2016 Daniel Farrell <dfarrell@redhat.com> - 4.3.0-1.1345
- Create 4.3.0-1.1345 RPM